...
def ocr_correct_words(words, n_best=10, dictionary=None, all_candidates=True):
	return _normalize(words, "ocr.pt", n_best=n_best, dictionary=dictionary, all_candidates=all_candidates)
